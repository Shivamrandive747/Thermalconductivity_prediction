...
poor at the second. The first half is demonstrably in hand: figures of merit approaching
$zT \approx 1.5$ have been demonstrated in $p$-type \ce{FeNbSb}~\cite{fu2015realizing} and
$zT \approx 1.4$ in \ce{ZrCoBi}~\cite{zhu2018discovery}, in a class that is mechanically robust,
stable to high temperature, and built from abundant, non-toxic elements. The second half is not.
The class conducts heat through the lattice too well, and because the figure of merit varies
inversely with the lattice thermal conductivity $\kappa_L$, essentially every advance here has come
from suppressing it---compound by compound, after synthesis. Identifying compounds whose $\kappa_L$
is intrinsically low before they are made is the central screening problem.
